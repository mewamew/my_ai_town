...
checks=(
	...
	"res://tests/offline_resident_model_rebind_ui_route_test.gd|OFFLINE_RESIDENT_MODEL_REBIND_UI_ROUTE_PASS|121"
	"res://tests/offline_resident_model_rebind_load_page_test.gd|OFFLINE_RESIDENT_MODEL_REBIND_LOAD_PAGE_PASS|46"
